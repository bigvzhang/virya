...
inline void center_stdout(const char* content, const size_t width, const char fillchar, bool newline){center_output(stdout,content,width,fillchar,newline);}
inline void center_stderr(const char* content, const size_t width, const char fillchar, bool newline){center_output(stderr,content,width,fillchar,newline);}
inline void center_stdout(const char* content, const size_t left, const size_t width, const char fillchar, bool newline){center_output(stdout,content,left, width,fillchar,newline);}
inline void center_stderr(const char* content, const size_t left, const size_t width, const char fillchar, bool newline){center_output(stderr,content,left, width,fillchar,newline);}
inline void stdout_putline(const size_t width=79, const char fillchar='='){center_output(stdout, "", width, fillchar, true);}
inline void stderr_putline(const size_t width=79, const char fillchar='='){center_output(stderr, "", width, fillchar, true);}
